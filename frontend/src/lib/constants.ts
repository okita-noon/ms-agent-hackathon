export const STATUS_COLORS: Record<string, { bg: string; text: string; chart: string; border: string }> = {
  ...
  "受注済み": { bg: "bg-blue-50", text: "text-blue-700", chart: "#3b82f6", border: "border-blue-200" },
  "配送中": { bg: "bg-orange-50", text: "text-orange-700", chart: "#f97316", border: "border-orange-200" },
...
export const ACCEPTED_ORDER_STATUSES = new Set(["受注済み", "配送中", "完了"]);
