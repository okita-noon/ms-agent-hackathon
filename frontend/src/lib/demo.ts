...
export function getDemoOrders(): Order[] {
  ...
  return [
    ...
    { uid: "ORD-002", tenant_id: "T-001", order_date: ts(14, 57), delivery_date: today, customer_id: "C-001", customer_name: "丸山 太郎", source: "Email", items: [{ product_name: "さくらんぼ", quantity: 10, unit: "パック", temperature_zone: "冷蔵" }], delivery_carrier: "冷蔵ヤマト便", delivery_route: "東北便", delivery_time_slot: "16:00", status: "配送", remarks: undefined, updated_at: ts(15, 5) },
    ...
    { uid: "ORD-006", tenant_id: "T-001", order_date: ts(11, 45), delivery_date: today, customer_id: "C-003", customer_name: "田中 一郎", source: "Phone", items: [{ product_name: "ぶどう", quantity: 8, unit: "房", temperature_zone: "常温" }], delivery_carrier: "自社便", delivery_route: "九州便", delivery_time_slot: "18:00-20:00", status: "返信待ち", remarks: undefined, updated_at: ts(12, 0) },
    { uid: "ORD-007", tenant_id: "T-001", order_date: ts(9, 15), delivery_date: today, customer_id: "C-004", customer_name: "鈴木 次郎", source: "FAX", items: [{ product_name: "みかん", quantity: 20, unit: "箱", temperature_zone: "冷蔵" }], delivery_carrier: "冷蔵ヤマト便", delivery_route: "北海道便", status: "製造", remarks: undefined, updated_at: ts(10, 0) },
  ];
}
