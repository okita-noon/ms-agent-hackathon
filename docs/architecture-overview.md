...
⑥ 出力・UI層
   ...
   ※ ダッシュボード上の例外対応支援Agentは docs/dashboard-agent-design.md を参照
```
...
| `docs/dashboard-agent-design.md` | ダッシュボード上のException Triage Agent・Resolution Agent・Feature Flag設計 |
