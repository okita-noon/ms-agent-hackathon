...
export AZURE_OPENAI_ENDPOINT="https://ai-orderai-dev2.openai.azure.com/"
...
# デプロイ済み環境に対して実行
python tests/simulate_phone_call.py \
  --base-url https://ca-api-orderai-dev2.mangoground-6945bb56.japaneast.azurecontainerapps.io
...
```
https://ca-api-orderai-dev2.mangoground-6945bb56.japaneast.azurecontainerapps.io/api/phone-webhook?code=<EVENTGRID_WEBHOOK_KEY>
```

`EVENTGRID_WEBHOOK_KEY` の値は Container Apps の env から確認:
```bash
az containerapp show --name ca-api-orderai-dev2 --resource-group rg-orderai-dev2 \
