...
def get_intake_instructions(channel: str = "line") -> str:
    ...
    return _build_instructions(
        INTAKE_AGENT_INSTRUCTIONS, channel, ["overview.md", "intake_manual.md"]
    )
...
def get_exception_instructions(channel: str = "line") -> str:
    ...
    return _build_instructions(
        EXCEPTION_AGENT_INSTRUCTIONS, channel, ["overview.md", "exception_manual.md"]
    )
...
def get_inventory_instructions(channel: str = "line") -> str:
    ...
    return _build_instructions(
        INVENTORY_AGENT_INSTRUCTIONS, channel, ["overview.md", "inventory_manual.md"]
    )
...
def get_orchestrator_instructions(channel: str = "line") -> str:
    ...
    return _build_instructions(
        ORCHESTRATOR_INSTRUCTIONS, channel, ["overview.md"]
    )
