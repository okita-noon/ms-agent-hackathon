...
function getDemoOrders() {
  ...
  return [
    ...
    { uid: 'ORD-003', tenant_id: 'T-001', order_date: today, delivery_date: today, customer_id: 'C-003', customer_name: '洋食キッチンつばめ', source: 'Phone', items: [{ product_name: 'メロン', quantity: 3, unit: '玉', temperature_zone: '冷凍' }], delivery_carrier: '自社便', delivery_route: '中部便', status: '製造', remarks: null },
    { uid: 'ORD-004', tenant_id: 'T-001', order_date: today, delivery_date: today, customer_id: 'C-004', customer_name: '鮨処みなと', source: 'LINE', items: [{ product_name: 'いちご', quantity: 15, unit: 'パック', temperature_zone: '常温' }, { product_name: 'ぶどう', quantity: 8, unit: '房', temperature_zone: '常温' }], delivery_carrier: '自社便', delivery_route: '九州便', status: '配送', remarks: null },
    { uid: 'ORD-005', tenant_id: 'T-001', order_date: today, delivery_date: today, customer_id: 'C-005', customer_name: 'カフェ森ノ音', source: 'Phone', items: [{ product_name: 'みかん', quantity: 100, unit: '個', temperature_zone: '冷凍' }], delivery_carrier: '冷凍ヤマト便', delivery_route: '北海道便', status: '要対応', remarks: '在庫不足のため担当者確認中' },
    { uid: 'ORD-006', tenant_id: 'T-001', order_date: today, delivery_date: today, customer_id: 'C-006', customer_name: '中華食堂龍華', source: 'LINE', items: [{ product_name: 'レモン', quantity: 30, unit: '個', temperature_zone: '常温' }], delivery_carrier: '自社便', delivery_route: '東北便', status: '完了', remarks: null },
  ];
}
...
function getDemoCustomers() {
  return [
    { id: 'C-001', tenant_id: 'T-001', name: 'ビストロ青葉', short_name: '青葉', line_user_id: null, phone: '03-1234-5678', email: 'test@example.com', active: true },
    { id: 'C-002', tenant_id: 'T-001', name: '炭火焼鳥とり善', short_name: 'とり善', line_user_id: 'U1234567890abcdef', phone: '06-9876-5432', email: null, active: true },
    { id: 'C-003', tenant_id: 'T-001', name: '洋食キッチンつばめ', short_name: 'つばめ', line_user_id: null, phone: null, email: 'demo@example.com', active: true },
  ];
}
