...
from src.services.tenant_resolver import get_demo_tenant_config, resolve_tenant_by_id, resolve_tenant_for_line
...
class TestResolveTenant:
    ...
    def test_resolve_by_id(self):
        ...
        assert ctx.tenant_id == "T-001"  # demo always returns T-001
